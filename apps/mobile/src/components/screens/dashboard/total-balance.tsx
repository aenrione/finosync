            ...
            </Text>
            {
              bal.changePct && (
                <View className="flex-row items-center">
                  <Icon name="TrendingUp" className="text-green-600 mr-1" size={16} />
                  <Text className="text-sm text-green-600 font-medium">{bal.changePct ? `+${bal.changePct}% this month` : ""}</Text>
                </View>
              )
            }
          </View>
