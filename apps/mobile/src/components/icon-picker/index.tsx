  ...
  return (
    <Modal isVisible={isVisible} onBackdropPress={onClose}>
      <View className="flex items-center justify-center">
        <ScrollView contentContainerClassName="flex-row flex-wrap justify-center bg-white p-5 rounded-xl">
        ...
        <TouchableOpacity
          className="bg-gray-500 px-4 py-2 rounded mt-2"
          onPress={onClose}
        >
          <Text className="text-white text-base">{t("cancel")}</Text>
        </TouchableOpacity>
      </View>
    </Modal>
  )
