...
const currencyConfig = {
  USD: { symbol: "$", color: colors.chart.blue, flag: "🇺🇸" },
  EUR: { symbol: "€", color: colors.chart.green, flag: "🇪🇺" },
  GBP: { symbol: "£", color: colors.chart.purple, flag: "🇬🇧" },
  CLP: { symbol: "$", color: colors.chart.red, flag: "🇨🇱" },
}
    ...
    <View className="mt-6">
      <View className="flex-row justify-between items-center mb-4">
        <View className="flex-row items-center">
          <Icon name="ChartPie" className="text-success mr-2" size={20} />
