      ...
      <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false}>
        ...
        <View className="mt-5">
          ...
          {budgets.map((budget) => {
            ...
            return (
              <View key={budget.id} className="bg-card rounded-2xl p-4 mb-3 border border-border">
        ...
        <View className="mt-5 mb-8">
          ...
          <View className="bg-card rounded-2xl p-4 mb-3 border border-border flex-row">
